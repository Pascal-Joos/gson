    ...
    void add(Node<K, V> node) {
      ...
      for (int scale = 4; (size & scale - 1) == scale - 1; scale *= 2) {
        if (leavesSkipped == 0) {
          ...
          stack = center;
          Node<K, V> nonNullCenter = center;
          nonNullCenter.left = left;
          nonNullCenter.right = right;
          Node<K, V> nonNullRight = right;
          nonNullCenter.height = nonNullRight.height + 1;
          left.parent = nonNullCenter;
          nonNullRight.parent = nonNullCenter;
